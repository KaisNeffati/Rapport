...
\begin{figure}[h!]
	...
	\mycaption[filiales et clients de Sofrecom.]{Docker images}
...
\begin{figure}[h!]
	...
	\mycaption[filiales et clients de Sofrecom.]{StreamingProcessing spark job in accepted status.}
	\label{fig:FilialesEtClients}
\end{figure}
\newpage
The next figure show the BatchProcessing job in it's running status:
\begin{figure}[h!]
	...
	\mycaption[filiales et clients de Sofrecom.]{StreamingProcessing spark job in running status.}
	\label{fig:FilialesEtClients}
\end{figure}
...
\begin{figure}[h!]
	...
	\mycaption[filiales et clients de Sofrecom.]{BatchSaveToHDFS spark job in accepted status.}
	\label{fig:FilialesEtClients}
\end{figure}
\newpage
...
\begin{figure}[h!]
	...
	\mycaption[filiales et clients de Sofrecom.]{Running job status Hadoop Yarn UI .}
	\label{fig:FilialesEtClients}
\end{figure}
\newline
...
\begin{figure}[h!]
	...
	\mycaption[filiales et clients de Sofrecom.]{Application Master dashboard	 .}
	\label{fig:FilialesEtClients}
\end{figure}
\newpage
...
\begin{figure}[h!]
	...
	\mycaption[filiales et clients de Sofrecom.]{Job log .}
	\label{fig:FilialesEtClients}
\end{figure}
...
\begin{figure}[h!]
	...
	\mycaption[filiales et clients de Sofrecom.]{Job log Resualts .}
	\label{fig:FilialesEtClients}
\end{figure}
\newpage
